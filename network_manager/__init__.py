...
def main(global_config, **settings):
    ...
    # Add a route / path called node_register at /node/register.  This is the 'admin' page where an entry can be added
    # to the database
    ...
    # Returns details about a particular node in json
